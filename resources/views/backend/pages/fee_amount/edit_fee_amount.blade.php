        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li  class="float-left"><span>Edit Student Fee Amount</span></li>
...
<div class="main-content-inner">
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                     <form id="addFeeAmount" action="{{(route('admin.student.fee_amount.update', $editData['0']->fee_category_id))}}" method="POST" enctype="multipart/form-data">
                       @csrf
                         @if(isset($editData))
                            @method('PUT')
                        @endif
                       ...
                       <div class="form-row">
                           <div class="form-group col-md-3 col-sm-8">
                            ...
                            <div class="form-group col-md-3 col-sm-8">
                                ...
                                <input type="number" name="amount[]" value="{{$edit->amount}}" class="form-control">
                            </div> 
