...
@section('title')
Manage Exam Fee Page - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Exam Fee</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.student_reg.index') }}">Exam Fee</a></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    ...
    <div class="card-body">
      <div class="form-row">
        ...
        <div class="form-group col-md-3 col-sm-8">
            <label for="class">Exam Type <font style="color: red;">*</font></label>
            ...
            <div class="form-group col-md-3">
              <a id="searchefee" class="btn btn-success btn-sm" name="search" style="margin-top: 23px;">Search</a>  
            </div>
                </div><br/>
