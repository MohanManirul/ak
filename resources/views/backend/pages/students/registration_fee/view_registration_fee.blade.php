...
@section('title')
Manage Registration Fee Page - Admin Panel
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Registration Fee</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('admin.student_reg.index') }}">Registration Fee</a></li>
                </ul>
            </div>
        </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-4 col-sm-8">
            ...
            <div class="form-group col-md-4">
              <a id="searchrfee" class="btn btn-success btn-sm" name="search" style="margin-top: 23px;">Search</a>  
            </div>
                </div><br/>
