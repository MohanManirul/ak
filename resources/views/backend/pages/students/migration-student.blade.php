...
<div class="main-content-inner">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="myForm" action="{{ route('admin.student.migration.store', $editData->student_id)}}" method="POST"  enctype="multipart/form-data">
                       @csrf
    ...
    <button type="submit" class="btn btn-primary btn-sm mt-4 pr-4 pl-4">{{(@$editData)?'Migrate':'Submit'}}</button>
                    </form>
                </div>
            </div>
        </div>
